...
v4l2-ctl -d $CAMERA -c saturation=76

# ゲインを設定する
# gain: min=0 max=100 step=1 default=0 value=0
v4l2-ctl -d $CAMERA -c gain=100
...
v4l2-ctl -d $CAMERA -c white_balance_temperature_auto=1
...
v4l2-ctl -d $CAMERA -c exposure_absolute=156
